const save = require("../util/saveFile");
...
async function main(file, filename) {
  ...
  console.log("Lendo os modelos api");
  ...
  console.log("Identificado um total de :", result.length);
 ...
 // save.saveFile(filename, out.toBuffer("image/jpeg"));
  console.log(`Terminado, resultado ${filename}`);
